 ...
 */
angular.module('ui.directives').directive('uiCodemirror', ['ui.config', '$timeout', 'editor',
    function(uiConfig, $timeout, editor) {
        'use strict';
        ...
        return {
            ...
            link: function(scope, elm, attrs, ngModel) {
                ...
                // HACK: we wait until the code is loaded to refresh the UI.
                elm.css('display', 'none');
                var refresh = function() {
                    if (codeMirror !== undefined && codeMirror.doc.size > 1) {
                        codeMirror.refresh();
                        elm.focus();
                        editor.setCodeMirror(codeMirror);
                    } else {
